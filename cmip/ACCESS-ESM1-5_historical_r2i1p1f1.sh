...
while [ "$d" != 2015-01-01 ]; do
	...
	python /home/548/ab4502/working/ExtremeWind/wrf_non_parallel.py -m ACCESS-ESM1-5 -r aus -t1 $start_time -t2 $end_time --issave True --outname ACCESS-ESM1-5_historical_r2i1p1f1 -e historical --ens r2i1p1f1 --group CSIRO
