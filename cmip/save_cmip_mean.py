...
def save_cmip_mean(models, p, experiment, y1, y2):
	...
	xr.Dataset(data_vars={p:(("lat","lon"), mean)}, \
		...
		to_netcdf("/g/data/eg3/ab4502/ExtremeWind/aus/regrid_1.5/"+p+\
			"_"+str(y1)+"_"+str(y2)+"_ensemble_mean.nc",\
		    engine="h5netcdf")
...
if __name__ == "__main__":
	...
	save_cmip_mean(models, "lr36", "historical", 1979, 2005)
	save_cmip_mean(models, "mhgt", "historical", 1979, 2005)
	save_cmip_mean(models, "ml_el", "historical", 1979, 2005)
	save_cmip_mean(models, "qmean01", "historical", 1979, 2005)
	save_cmip_mean(models, "srhe_left", "historical", 1979, 2005)
	save_cmip_mean(models, "Umean06", "historical", 1979, 2005)
