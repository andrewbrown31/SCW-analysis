...
while [ "$d" != 1990-01-01 ]; do
	...
	python /home/548/ab4502/working/ExtremeWind/cmip/wrf_non_parallel_reduced.py -m ACCESS1-0 -r global -t1 $start_time -t2 $end_time --issave True --outname ACCESS1-0_historical_r1i1p1 -e historical --ens r1i1p1
