...
while [ "$d" != 2010-01-01 ]; do
	...
	python /home/548/ab4502/working/ExtremeWind/wrf_non_parallel.py -m IPSL-CM5A-LR -r aus -t1 $start_time -t2 $end_time --issave True --outname IPSL-CM5A-LR_historical_r1i1p1 -e historical --ens r1i1p1
