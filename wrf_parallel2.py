...
#	Same as wrf_python.py, except that instead of using mpi4py, we use the multiprocessing 
#	package. This means that processes are restricted to one node (16), however the data
#	does not need to be parsed between nodes.
...
def wrf_parallel(it):
	...
	output = np.zeros((len(param),len(lat),len(lon)))
	...
	#Fill output
	output = fill_output(output, None, param, None, "ml_cape", ml_cape)
	output = fill_output(output, None, param, None, "mu_cape", mu_cape)
	output = fill_output(output, None, param, None, "eff_cape", eff_cape)
	output = fill_output(output, None, param, None, "sb_cape", sb_cape)
	output = fill_output(output, None, param, None, "ml_cin", ml_cin)
	output = fill_output(output, None, param, None, "mu_cin", ml_cin)
	output = fill_output(output, None, param, None, "eff_cin", ml_cin)
	output = fill_output(output, None, param, None, "sb_cin", sb_cin)
	output = fill_output(output, None, param, None, "ml_lcl", ml_lcl)
	output = fill_output(output, None, param, None, "mu_lcl", mu_lcl)
	output = fill_output(output, None, param, None, "eff_lcl", eff_lcl)
	output = fill_output(output, None, param, None, "sb_lcl", sb_lcl)
	output = fill_output(output, None, param, None, "ml_el", ml_el)
	output = fill_output(output, None, param, None, "mu_el", mu_el)
	output = fill_output(output, None, param, None, "eff_el", eff_el)
	output = fill_output(output, None, param, None, "sb_el", sb_el)
	if model == "erai":
		output = fill_output(output, None, param, None, "cape", mod_cape[t])
		output = fill_output(output, None, param, None, "cp", cp[t])

	output = fill_output(output, None, param, None, "lr01", lr01)
	output = fill_output(output, None, param, None, "lr03", lr03)
	output = fill_output(output, None, param, None, "lr13", lr13)
	output = fill_output(output, None, param, None, "lr24", lr24)
	output = fill_output(output, None, param, None, "lr36", lr36)
	output = fill_output(output, None, param, None, "lr_subcloud", lr_subcloud)
	output = fill_output(output, None, param, None, "lr_freezing", lr_freezing)
	output = fill_output(output, None, param, None, "mhgt", melting_hgt)
	output = fill_output(output, None, param, None, "wbz", hwb0)
	output = fill_output(output, None, param, None, "qmean01", qmean01)
	output = fill_output(output, None, param, None, "qmean03", qmean03)
	output = fill_output(output, None, param, None, "qmean06", qmean06)
	output = fill_output(output, None, param, None, "qmeansubcloud", qmeansubcloud)
	output = fill_output(output, None, param, None, "q_melting", q_melting)
	output = fill_output(output, None, param, None, "q1", q1)
	output = fill_output(output, None, param, None, "q3", q3)
	output = fill_output(output, None, param, None, "q6", q6)
	output = fill_output(output, None, param, None, "rhmin01", rhmin01)
	output = fill_output(output, None, param, None, "rhmin03", rhmin03)
	output = fill_output(output, None, param, None, "rhmin13", rhmin13)
	output = fill_output(output, None, param, None, "rhminsubcloud", rhminsubcloud)
	output = fill_output(output, None, param, None, "v_totals", v_totals)
	output = fill_output(output, None, param, None, "c_totals", c_totals)
	output = fill_output(output, None, param, None, "t_totals", t_totals)
	output = fill_output(output, None, param, None, "pwat", pwat)
	output = fill_output(output, None, param, None, "maxtevv", maxtevv)
	output = fill_output(output, None, param, None, "te_diff", te_diff)
	output = fill_output(output, None, param, None, "tei", tei)
	output = fill_output(output, None, param, None, "dpd700", dpd700)
	output = fill_output(output, None, param, None, "dpd850", dpd850)
	output = fill_output(output, None, param, None, "dcape", dcape)
	output = fill_output(output, None, param, None, "ddraft_temp", ddraft_temp)

	output = fill_output(output, None, param, None, "Umeanwindinf", Umeanwindinf)
	output = fill_output(output, None, param, None, "Umean01", Umean01)
	output = fill_output(output, None, param, None, "Umean03", Umean03)
	output = fill_output(output, None, param, None, "Umean06", Umean06)
	output = fill_output(output, None, param, None, "Umean800_600", Umean800_600)
	output = fill_output(output, None, param, None, "Uwindinf", Uwindinf)
	output = fill_output(output, None, param, None, "U500", U500)
	output = fill_output(output, None, param, None, "U1", U1)
	output = fill_output(output, None, param, None, "U3", U3)
	output = fill_output(output, None, param, None, "U6", U6)
	output = fill_output(output, None, param, None, "Ust_left", Ust_left)
	output = fill_output(output, None, param, None, "Usr01_left", Usr01_left)
	output = fill_output(output, None, param, None, "Usr03_left", Usr03_left)
	output = fill_output(output, None, param, None, "Usr06_left", Usr06_left)
	output = fill_output(output, None, param, None, "wg10", wg10[t])
	output = fill_output(output, None, param, None, "U10", U10)
	output = fill_output(output, None, param, None, "scld", scld)
	output = fill_output(output, None, param, None, "s01", s01)
	output = fill_output(output, None, param, None, "s03", s03)
	output = fill_output(output, None, param, None, "s06", s06)
	output = fill_output(output, None, param, None, "s010", s010)
	output = fill_output(output, None, param, None, "s13", s13)
	output = fill_output(output, None, param, None, "s36", s36)
	output = fill_output(output, None, param, None, "ebwd", ebwd)
	output = fill_output(output, None, param, None, "srh01_left", srh01_left)
	output = fill_output(output, None, param, None, "srh03_left", srh03_left)
	output = fill_output(output, None, param, None, "srh06_left", srh06_left)
	output = fill_output(output, None, param, None, "srhe_left", srhe_left)
	output = fill_output(output, None, param, None, "omega01", omega01)
	output = fill_output(output, None, param, None, "omega03", omega03)
	output = fill_output(output, None, param, None, "omega06", omega06)

	output = fill_output(output, None, param, None, "F10", F10)
	output = fill_output(output, None, param, None, "Fn10", Fn10)
	output = fill_output(output, None, param, None, "Fs10", Fs10)
	output = fill_output(output, None, param, None, "icon10", icon10)
	output = fill_output(output, None, param, None, "vgt10", vgt10)
	output = fill_output(output, None, param, None, "conv10", conv10)
	output = fill_output(output, None, param, None, "vo10", vo10)

	output = fill_output(output, None, param, None, "stp_cin_left", stp_cin_left)
	output = fill_output(output, None, param, None, "stp_fixed_left", stp_fixed_left)
	output = fill_output(output, None, param, None, "windex", windex)
	output = fill_output(output, None, param, None, "gustex", gustex)
	output = fill_output(output, None, param, None, "hmi", hmi)
	output = fill_output(output, None, param, None, "wmsi_ml", wmsi_ml)
	output = fill_output(output, None, param, None, "dmi", dmi)
	output = fill_output(output, None, param, None, "mwpi_ml", mwpi_ml)
	output = fill_output(output, None, param, None, "moshe", moshe)
	output = fill_output(output, None, param, None, "ship", ship)
	output = fill_output(output, None, param, None, "scp", scp)
	output = fill_output(output, None, param, None, "scp_fixed", scp_fixed)
	output = fill_output(output, None, param, None, "eff_sherb", eff_sherb)
	output = fill_output(output, None, param, None, "sherb", sherb)
	output = fill_output(output, None, param, None, "k_index", k_index)
	output = fill_output(output, None, param, None, "mlcape*s06", mlcs6)
	output = fill_output(output, None, param, None, "mucape*s06", mucs6)
	output = fill_output(output, None, param, None, "sbcape*s06", sbcs6)
	output = fill_output(output, None, param, None, "effcape*s06", effcs6)
	if model == "erai":
		output = fill_output(output, None, param, None, "cape*s06", cs6)
	output = fill_output(output, None, param, None, "mosh", mosh)
	output = fill_output(output, None, param, None, "wndg", wndg)
	output = fill_output(output, None, param, None, "sweat", sweat)
	output = fill_output(output, None, param, None, "mmp", mmp)
	output = fill_output(output, None, param, None, "mburst", mburst)
	output = fill_output(output, None, param, None, "convgust_wet", convgust_wet)
	output = fill_output(output, None, param, None, "convgust_dry", convgust_dry)
	output = fill_output(output, None, param, None, "dcp", dcp)
	output = fill_output(output, None, param, None, "dmgwind", dmgwind)
	output = fill_output(output, None, param, None, "dmgwind_fixed", dmgwind_fixed)
...
if __name__ == "__main__":
	...
	if model == "erai":
		...
		output_data = np.zeros((len(param),len(date_list),shape[0],shape[1]))

	
	pool = multiprocessing.Pool()
	param_temp = pool.map(wrf_parallel,itertools.product(np.arange(0,len(date_list)),[param]))
	pool.close()
	pool.join()
	param_out = []
