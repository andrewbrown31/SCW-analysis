...
while [ "$d" != 2006-01-01 ]; do
	...
	python /home/548/ab4502/working/ExtremeWind/wrf_non_parallel.py -m CNRM-CM5 -r aus -t1 $start_time -t2 $end_time --issave True --outname CNRM-CM5_historical_r1i1p1 -e historical --ens r1i1p1 --group CNRM-CERFACS --al33 True
