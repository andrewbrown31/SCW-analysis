...
#PBS -l ncpus=1
#PBS -o /home/548/ab4502/working/ExtremeWind/jobs/messages/wrf_python_ACCESS1-3_historical_1.o 
#PBS -e /home/548/ab4502/working/ExtremeWind/jobs/messages/wrf_python_ACCESS1-3_historical_1.e 
...
python /home/548/ab4502/working/ExtremeWind/wrf_non_parallel_reduced.py -m ACCESS1-3 -r global -t1 2000010100 -t2 2005123118 --issave True --outname ACCESS1-3_historical_r1i1p1 -e historical --ens r1i1p1
