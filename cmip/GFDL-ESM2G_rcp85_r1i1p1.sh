...
while [ "$d" != 2101-01-01 ]; do
	...
	python /home/548/ab4502/working/ExtremeWind/wrf_non_parallel_reduced.py -m GFDL-ESM2G -r global -t1 $start_time -t2 $end_time --issave True --outname GFDL-ESM2G_rcp85_r1i1p1 -e rcp85 --ens r1i1p1
