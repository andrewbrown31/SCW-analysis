...
while [ "$d" != 2106-01-01 ]; do
	...
	python /home/548/ab4502/working/ExtremeWind/wrf_non_parallel.py -m MRI-CGCM3 -r aus -t1 $start_time -t2 $end_time --issave True --outname MRI-CGCM3_rcp85_r1i1p1 -e rcp85 --ens r1i1p1 --al33 True --group MRI --ver3hr v20120119
