...
if __name__ == "__main__":
	...
	save_cmip_mean(models, "mu_cape", "historical", 1979, 2005, "cmip5", 1979, 2005)
	save_cmip_mean(models, "dcape", "historical", 1979, 2005, "cmip5", 1979, 2005)
	save_cmip_mean(models, "ebwd", "historical", 1979, 2005, "cmip5", 1979, 2005)
	save_cmip_mean(models, "lr03", "historical", 1979, 2005, "cmip5", 1979, 2005)
	save_cmip_mean(models, "lr700_500", "historical", 1979, 2005, "cmip5", 1979, 2005)
	save_cmip_mean(models, "dp850", "historical", 1979, 2005, "cmip5", 1979, 2005)
	save_cmip_mean(models, "ta850", "historical", 1979, 2005, "cmip5", 1979, 2005)
	save_cmip_mean(models, "ta500", "historical", 1979, 2005, "cmip5", 1979, 2005)
	save_cmip_mean(models, "Umean06", "historical", 1979, 2005, "cmip5", 1979, 2005)
	save_cmip_mean(models, "s06", "historical", 1979, 2005, "cmip5", 1979, 2005)
