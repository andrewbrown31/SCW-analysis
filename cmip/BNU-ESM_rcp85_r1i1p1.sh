...
python /home/548/ab4502/working/ExtremeWind/wrf_non_parallel_reduced.py -m BNU-ESM -r global -t1 2081010100 -t2 2100123123 --issave True --outname BNU-ESM_rcp85_r1i1p1 -e rcp85 --ens r1i1p1
