...
python working/ExtremeWind/cmip/cmip_scenario.py -p mhgt -e rcp85 --era5_y1 1979 --era5_y2 2005 --hist_y1 1979 --hist_y2 2005 --scenario_y1 2006 --scenario_y2 2018 --force_compute True -m GFDL-CM3 GFDL-ESM2G GFDL-ESM2M IPSL-CM5A-LR IPSL-CM5A-MR MIROC5 MRI-CGCM
