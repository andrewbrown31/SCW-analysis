...
python /home/548/ab4502/working/ExtremeWind/wrf_non_parallel.py -m BNU-ESM -r aus -t1 1950010100 -t2 2005123118 --issave True --outname BNU-ESM_historical_r1i1p1 -e historical --ens r1i1p1
