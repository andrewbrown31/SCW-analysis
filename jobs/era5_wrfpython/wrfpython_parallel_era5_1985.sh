...
#PBS -l ncpus=1
#PBS -o /home/548/ab4502/working/ExtremeWind/jobs/messages/era5_wrf_python_1985.o 
#PBS -e /home/548/ab4502/working/ExtremeWind/jobs/messages/era5_wrf_python_1985.e 
...
while [ "$d" != 1985-08-01 ]; do
  ...
  python /home/548/ab4502/working/ExtremeWind/wrf_parallel.py -m era5 -r aus -t1 $start_time -t2 $end_time --issave True --outname era5
...
while [ "$d" != 1986-01-01 ]; do
  ...
  cdo -z zip_1 -v mergetime "${path}era5_${files}"* "${path}monthly_${start_date}_${end_date}"
  rm "${path}era5_${files}"*
