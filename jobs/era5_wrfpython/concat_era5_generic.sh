...
#PBS -l ncpus=1
#PBS -l other=gdata<x>
#PBS -o /home/548/ab4502/working/ExtremeWind/jobs/messages/concat_era5_YEAR.o
#PBS -e /home/548/ab4502/working/ExtremeWind/jobs/messages/concat_era5_YEAR.e

#Concaternate daily netcdf output into monthly files
module load cdo
path="/g/data/eg3/ab4502/ExtremeWind/aus/era5/"
d=YEAR-01-01
while [ "$d" != YearEnd-01-01 ]; do
