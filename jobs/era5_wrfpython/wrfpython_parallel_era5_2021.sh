...
#PBS -l ncpus=1
#PBS -o /home/548/ab4502/working/ExtremeWind/jobs/messages/era5_wrf_python_2021.o 
#PBS -e /home/548/ab4502/working/ExtremeWind/jobs/messages/era5_wrf_python_2021.e 
...
#  file="/g/data/eg3/ab4502/ExtremeWind/aus/era5/era5_$(date -d "$d" +%Y%m%d)_$(date -d "$d"  +%Y%m%d).nc"
#  if [ -e ${file} ]; then
