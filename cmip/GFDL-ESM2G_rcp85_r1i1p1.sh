...
while [ "$d" != 2096-01-01 ]; do
	...
	python /home/548/ab4502/working/ExtremeWind/wrf_non_parallel.py -m GFDL-ESM2G -r aus -t1 $start_time -t2 $end_time --issave True --outname GFDL-ESM2G_rcp85_r1i1p1 -e rcp85 --ens r1i1p1
